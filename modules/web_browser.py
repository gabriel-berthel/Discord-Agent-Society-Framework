...
class WebBrowser:
    ...
    async def _process_with_llm(self, query, search_results):
        ...
        payload = {
            ...
            "messages": [
                {"role": "system",
                 "content": "You are a web research assistant who analyzes results and provides accurate answers."},
        ...
        try:
            if self.use_ollama:
                response = ollama.chat(
                    ...
                    messages=[
                        {"role": "system",
                         "content": "You are an assistant specialized in creating concise summaries of multiple research findings."},
...
async def main():
    ...
    # test 
    summary_results = await browser.summarize_search("What are the latest advances in artificial intelligence?",
                                                     max_length=150)
    print("\n=== SUMMARY ===")
